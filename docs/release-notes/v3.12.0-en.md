...
Visit [Releases](https://github.com/farion1231/cc-switch/releases/latest) to download the official Web runtime assets.

### Official release assets

| Platform | Asset | Run |
| -------- | ----- | --- |
| Windows x86_64 | `cc-switch-web-v3.12.0-windows-x86_64.exe` | `./cc-switch-web-v3.12.0-windows-x86_64.exe` |
| macOS x86_64 | `cc-switch-web-v3.12.0-macos-x86_64` | `chmod +x ./cc-switch-web-v3.12.0-macos-x86_64 && ./cc-switch-web-v3.12.0-macos-x86_64` |
| Linux x86_64 | `cc-switch-web-v3.12.0-linux-x86_64-ubuntu20.04` | `chmod +x ./cc-switch-web-v3.12.0-linux-x86_64-ubuntu20.04 && ./cc-switch-web-v3.12.0-linux-x86_64-ubuntu20.04` |

### Runtime notes

- Default address: `http://127.0.0.1:17666`
- Override port: `CC_SWITCH_PORT=8080`
- Override host: `CC_SWITCH_HOST=0.0.0.0`
- Linux baseline: Ubuntu 20.04+
- macOS asset is unsigned and may require removing the quarantine attribute before first launch

Desktop Tauri packages are not part of the official release assets for this fork.
