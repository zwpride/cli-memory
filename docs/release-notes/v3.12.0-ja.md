...
[Releases](https://github.com/farion1231/cc-switch/releases/latest) から正式な Web ランタイム資産をダウンロードしてください。
...
- 既定アドレス: `http://127.0.0.1:17666`
- ポート変更: `CC_SWITCH_PORT=8080`
- ホスト変更: `CC_SWITCH_HOST=0.0.0.0`
- Linux ベースライン: Ubuntu 20.04+
- macOS アセットは未署名のため、初回起動前に隔離属性の削除が必要な場合があります

この fork の正式リリース資産にデスクトップ Tauri パッケージは含まれません。
