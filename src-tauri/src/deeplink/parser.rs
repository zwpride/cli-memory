...
//!
//! Parses climemory:// URLs into DeepLinkImportRequest structures.
...
/// Parse a climemory:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// climemory://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "climemory" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'climemory', got '{scheme}'"
        )));
    }
